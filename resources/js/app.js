...
Vue.component('input-mask', {
  template: `<input v-model="maskedValue" :maxlength="mask.length">`,
  props: {
    'value': String,
    'mask': String,
    'masked': {
...
Vue.component('listar-turmas', require('./components/ListarTurmas.vue').default);
Vue.component('cadastrar-turmas', require('./components/CadastrarTurmas.vue').default);
Vue.component('listar-alunos', require('./components/ListarAlunos.vue').default);
